...
def run(
    *,
    ...
    height:
        Output frame height in pixels (default 1280; must be divisible by 32).
    length:
    ...
    lora_strength:
        ...
        caller-supplied style LoRA.  Default is 1.0.
    unet_filename:
    ...
    base_lora_filename:
        Override the default base distilled LoRA filename.
    upscaler_filename:
